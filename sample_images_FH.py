...
# RUN_DIR = os.path.join('run', args.dataset, current_time)
# print(RUN_DIR)
...
parser.add_argument('--model', default='bm_FH', choices=['bm', 'bm_FH', 'bm_FH64', 'bm_FHrec', 'bm_FHrec64'])
...
parser.add_argument('--FH64_dir_train', default = 'dataFH/train_FH64.npy')
parser.add_argument('--FH64_dir_val', default = 'dataFH/val_FH64.npy')

parser.add_argument('--FHrec64_dir_train', default = 'dataFH/train_FHrec64.npy')
parser.add_argument('--FHrec64_dir_val', default = 'dataFH/val_FHrec64.npy')
